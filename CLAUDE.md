...
tests/
  ...
  test_validate.py
skills/databricks-schema-cli/SKILL.md  # Agent Skill: teaches an AI agent to drive the CLI
```
...
- When CLI commands, flags, or output shape change, update `skills/databricks-schema-cli/SKILL.md` to match
